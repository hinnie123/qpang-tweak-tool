...
namespace lua {
    ...
    inline std::vector<std::string> ingameInitLua = { R"DEL(
	    ...
	    CreateDialog(UI_IDD_GAME_HELP, SCREEN_WIDTH / 2 - 779 / 2, SCREEN_HEIGHT / 2 - 384 / 2, 779, 384, NULL_WINDOW_TITLE, -2, COMMON_RES_BASE+0, UIRECT_NINE)

		    EnableSkinColor(UI_IDD_GAME_HELP)
		    CreateCaptionBar(UI_IDD_GAME_HELP , UI_IDC_GAME_HELP_CAPTION, 14 , -22 , 112 , 24 ,4, COMMON_RES_BASE+0 , UIRECT_THREE)
	    ...
	    CreateNullDialog(UI_IDD_GAME_EVENTER, 0, SCREEN_HEIGHT / 12 + 1, 617, 44, 10)
